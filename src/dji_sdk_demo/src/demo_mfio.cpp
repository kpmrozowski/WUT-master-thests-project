...
main(int argc, char** argv)
{
  ...
  drone_activation_service  = nh.serviceClient<dji_osdk_ros::Activation>
    ("dji_sdk/activation");
  mfio_config_service       = nh.serviceClient<dji_osdk_ros::MFIOConfig>
    ("dji_sdk/mfio_config");
  mfio_set_value_service    = nh.serviceClient<dji_osdk_ros::MFIOSetValue>
...
bool pwmDemo() {
  ...
  dji_osdk_ros::MFIOConfig mfio_config;
  ...
  dji_osdk_ros::MFIOSetValue mfio_set_value;
