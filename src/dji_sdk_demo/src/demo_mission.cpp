...
uploadWaypoints(std::vector<DJI::OSDK::WayPointSettings>& wp_list,
                int responseTimeout, dji_osdk_ros::MissionWaypointTask& waypointTask)
{
...
main(int argc, char** argv)
{
  ...
  drone_activation_service =
    nh.serviceClient<dji_osdk_ros::Activation>("dji_sdk/activation");
  sdk_ctrl_authority_service = nh.serviceClient<dji_osdk_ros::SDKControlAuthority>(
    "dji_sdk/sdk_control_authority");
  drone_task_service =
    nh.serviceClient<dji_osdk_ros::DroneTaskControl>("dji_sdk/drone_task_control");
