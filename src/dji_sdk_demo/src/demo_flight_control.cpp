...
int main(int argc, char** argv)
{
  ...
  // Basic services
  sdk_ctrl_authority_service = nh.serviceClient<dji_osdk_ros::SDKControlAuthority> ("dji_sdk/sdk_control_authority");
  drone_task_service         = nh.serviceClient<dji_osdk_ros::DroneTaskControl>("dji_sdk/drone_task_control");
  query_version_service      = nh.serviceClient<dji_osdk_ros::QueryDroneVersion>("dji_sdk/query_drone_version");
