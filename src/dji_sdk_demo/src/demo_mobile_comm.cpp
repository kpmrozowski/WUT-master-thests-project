...
int main(int argc, char *argv[]) {
  ...
  from_mobile_data_subscriber = nh.subscribe<dji_osdk_ros::MobileData>
  ...
  mobile_data_service = nh.serviceClient<dji_osdk_ros::SendMobileData>
      ("dji_sdk/send_data_to_mobile");
  drone_activation_service  = nh.serviceClient<dji_osdk_ros::Activation>
      ("dji_sdk/activation");
  drone_arm_service         = nh.serviceClient<dji_osdk_ros::DroneArmControl>
      ("dji_sdk/drone_arm_control");
  drone_task_service        = nh.serviceClient<dji_osdk_ros::DroneTaskControl>
      ("dji_sdk/drone_task_control");
  sdk_ctrl_authority_service= nh.serviceClient<dji_osdk_ros::SDKControlAuthority>
  ...
  waypoint_upload_service   = nh.serviceClient<dji_osdk_ros::MissionWpUpload>
      ("dji_sdk/mission_waypoint_upload");
  waypoint_action_service   = nh.serviceClient<dji_osdk_ros::MissionWpAction>
      ("dji_sdk/mission_waypoint_action");
  hotpoint_upload_service   = nh.serviceClient<dji_osdk_ros::MissionHpUpload>
      ("dji_sdk/mission_hotpoint_upload");
  hotpoint_action_service   = nh.serviceClient<dji_osdk_ros::MissionHpAction>
      ("dji_sdk/mission_hotpoint_action");
  hotpoint_updateRadius_service   = nh.serviceClient<dji_osdk_ros::MissionHpUpdateRadius>
      ("dji_sdk/mission_hotpoint_updateRadius");
  hotpoint_update_yawRate_Service = nh.serviceClient<dji_osdk_ros::MissionHpUpdateYawRate>
  ...
  query_version_service      = nh.serviceClient<dji_osdk_ros::QueryDroneVersion>
...
void fromMobileDataSubscriberCallback(const dji_osdk_ros::MobileData::ConstPtr& from_mobile_data) {
...
ServiceAck armMotors() {
    dji_osdk_ros::DroneArmControl droneArmControl;
...
bool is_M100()
{
  dji_osdk_ros::QueryDroneVersion query;
...
void
setWaypointInitDefaults(dji_osdk_ros::MissionWaypointTask &waypointTask)
{
...
void
setHotpointInitDefault(dji_osdk_ros::MissionHotpointTask &hotpointTask)
{
...
ServiceAck
initWaypointMission(dji_osdk_ros::MissionWaypointTask &waypointTask)
{
...
ServiceAck
initHotpointMission(dji_osdk_ros::MissionHotpointTask &hotpointTask)
{
